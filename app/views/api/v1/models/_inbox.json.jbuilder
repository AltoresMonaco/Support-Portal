...
json.welcome_title_translations resource.channel.try(:welcome_title_translations)
json.welcome_tagline_translations resource.channel.try(:welcome_tagline_translations)
json.offline_message_translations resource.channel.try(:offline_message_translations)
json.reply_time_message_translations resource.channel.try(:reply_time_message_translations)
json.channel_greeting_translations resource.channel.try(:channel_greeting_translations)
